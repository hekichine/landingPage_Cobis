...
let render_Products = () => {
  const htmls = dataProducts.map((item, index) => {
    return `<div
                class="bee-col-item text-center col-lg-4 col-md-6 col-sm-6 col-12"
            >
  ...
  document.querySelector(".bee-product-slide").innerHTML = htmls.join("");
};
render_Products();
...
let dataCollections = [
  {
    ...
    img_url: "./assets/img/tabs/Collection/load-more-button.png",
    link_url:
  ...
  },
  {
    ...
    img_url: "./assets/img/tabs/Collection/shop-colletion-list.png",
...

  {
    id: 3,
    title: "Default",
    img_url: "./assets/img/tabs/Collection/shop-default.png",
  ...
  },
  {
    ...
    img_url: "./assets/img/tabs/Collection/shop-drawer-sidebar.png",
    link_url:
  ...
  },
  {
    id: 5,
    title: "Fullwidth",
    img_url: "./assets/img/tabs/Collection/shop-full-width.png",
    link_url:
  ...
  },
  {
    id: 6,
    title: "Left Sidebar",
    img_url: "./assets/img/tabs/Collection/shop-left-sidebar.png",
    link_url:
  ...
  },
  {
    id: 7,
    title: "Right Sidebar",
    img_url: "./assets/img/tabs/Collection/shop-right-sidebar.png",
    link_url:
...
let render_Collections = () => {
  ...
  document.querySelector(".bee-collection-slide").innerHTML = htmls.join("");
};
render_Collections();
...
let dataBlogs = [
  {
    id: 1,
    title: "Blog Classic",
    img_url: "./assets/img/tabs/blogs/blog-classic.png",
  ...
  },
  {
    id: 2,
    title: "Blog Grid",
    img_url: "./assets/img/tabs/blogs/blog-grid.png",
  ...
  },
  {
    id: 3,
    title: "Blog List",
    img_url: "./assets/img/tabs/blogs/blog-list.png",
  ...
  },
  {
    id: 4,
    title: "Blog Masory",
    img_url: "./assets/img/tabs/blogs/blog-masory.png",
  ...
  },
  {
    id: 5,
    title: "Blog Packery",
    img_url: "./assets/img/tabs/blogs/blog-pakery.png",
  ...
  },
  {
    id: 6,
    title: "Post Parallax",
    img_url: "./assets/img/tabs/blogs/post-scroll.png",
    link_url:
...
let renderBlog = () => {
  ...
  document.querySelector(".bee-blogs-slide").innerHTML = htmls.join("");
};
renderBlog();
let dataPages = [
  {
    id: 1,
    title: "About Us",
    img_url: "./assets/img/tabs/pages/about-1.png",
  ...
  },
  {
    id: 2,
    title: "About Me",
    img_url: "./assets/img/tabs/pages/about-me.png",
  ...
  },
  {
    id: 3,
    title: "Contact 01",
    img_url: "./assets/img/tabs/pages/contact-1.png",
  ...
  },
  {
    id: 4,
    title: "Contact 02",
    img_url: "./assets/img/tabs/pages/contact-2.png",
  ...
  },
  {
    id: 5,
    title: "FAQs 01",
    img_url: "./assets/img/tabs/pages/faq1.png",
  ...
  },
  {
    id: 6,
    title: "FAQs 02",
    img_url: "./assets/img/tabs/pages/faq2.png",
  ...
  },
  {
    id: 7,
    title: "Our Team",
    img_url: "./assets/img/tabs/pages/our-team.png",
  ...
  },
  {
    id: 8,
    title: "404 Error",
    img_url: "./assets/img/tabs/pages/404.png",
...
let renderPages = () => {
  ...
  document.querySelector(".bee-pages-slide").innerHTML = htmls.join("");
};
renderPages();
